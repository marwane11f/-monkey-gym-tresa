...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('bookingForm').addEventListener('submit', async function(e) {
    ...
    lastBookingId = Date.now().toString();
  ...
  document.getElementById('loginForm').addEventListener('submit', (e) => {
    e.preventDefault();
    document.getElementById('loginError').textContent = 'Area membri non disponibile in anteprima.';
  });

  // Register form
  document.getElementById('registerForm').addEventListener('submit', (e) => {
    e.preventDefault();
    document.getElementById('regError').textContent = 'Registrazione non disponibile in anteprima.';
  });
